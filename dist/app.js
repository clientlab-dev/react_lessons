...
*/
var aa=__webpack_require__(1),n=__webpack_require__(6),da=__webpack_require__(7);function ea(a,b,c,d,e,f,g,h){if(!a){a=void 0;if(void 0===b)a=Error("Minified exception occurred; use the non-minified dev environment for the full error message and additional helpful warnings.");else{var k=[c,d,e,f,g,h],l=0;a=Error(b.replace(/%s/g,function(){return k[l++]}));a.name="Invariant Violation"}a.framesToPop=1;throw a;}}
...
var _ListItems = __webpack_require__(25);

var _ListItems2 = _interopRequireDefault(_ListItems);

var _AddBar = __webpack_require__(31);
...
var ToDoList = function (_React$Component) {
	...
	_createClass(ToDoList, [{
		...
		value: function removeHandler(id) {
			var newListItems = this.state.ListItems.filter(function (v) {
				if (v.id != id) {
					return v;
				}
			});
		...
		key: "filterHandler",
		value: function filterHandler(str) {

			if (str.trim() != '') {
				var filteredListItems = this.state.ListItems.filter(function (v) {
...
var SearchBar = function (_React$Component) {
	...
	_createClass(SearchBar, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(
				'div',
				{ className: _SearchBar2.default[this.constructor.name] },
				_react2.default.createElement('input', { placeholder: 'Search', value: this.state.value, onChange: this.onChangehandler })
			);
		}
	}]);
...
if(false) {
	module.hot.accept("!!../../../../node_modules/css-loader/index.js??ref--1-1!../../../../node_modules/sass-loader/lib/loader.js??postcss!./SearchBar.scss", function() {
		var newContent = require("!!../../../../node_modules/css-loader/index.js??ref--1-1!../../../../node_modules/sass-loader/lib/loader.js??postcss!./SearchBar.scss");
...
// module
exports.push([module.i, ".SearchBar__SearchBar___T-K2C {\n  padding: 15px; }\n  .SearchBar__SearchBar___T-K2C input {\n    width: 100%;\n    padding: 4px 8px;\n    border: 1px solid  #9ac3c2;\n    border-radius: 4px;\n    font-size: 14px; }\n    .SearchBar__SearchBar___T-K2C input:focus {\n      outline: #FFFEEF; }\n", ""]);

// exports
exports.locals = {
	"SearchBar": "SearchBar__SearchBar___T-K2C"
};
...
var _ListItem3 = __webpack_require__(29);

var _ListItem4 = _interopRequireDefault(_ListItem3);
...
var ListItems = function (_React$Component) {
	...
	_createClass(ListItems, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(
				'div',
				{ className: _ListItem4.default[this.constructor.name] },
...
var ListItem = function (_React$Component) {
	...
	function ListItem(props) {
		...
		_this.removeHandler = _this.removeHandler.bind(_this);
		_this.doneHandler = _this.doneHandler.bind(_this);
		_this.state = {
			isDone: ""
		};
	...
	_createClass(ListItem, [{
		key: 'removeHandler',
		value: function removeHandler(props) {
		...
		value: function doneHandler(event) {
			if (this.state.isDone == "") {
				this.setState({ 'isDone': _ListItem2.default.isDone });
			} else {
		...
		value: function render() {
			return _react2.default.createElement(
				'li',
				{ id: "listItem_" + this.props.id, ref: this.myRef, onClick: this.doneHandler, className: _ListItem2.default[this.constructor.name] + " " + this.state.isDone },
				this.props.text,
				_react2.default.createElement(
					'button',
					{ className: _ListItem2.default['remove-btn'], onClick: this.removeHandler },
					'Remove'
				)
			);
		}
...
if(false) {
	module.hot.accept("!!../../../../node_modules/css-loader/index.js??ref--1-1!../../../../node_modules/sass-loader/lib/loader.js??postcss!./ListItem.scss", function() {
		var newContent = require("!!../../../../node_modules/css-loader/index.js??ref--1-1!../../../../node_modules/sass-loader/lib/loader.js??postcss!./ListItem.scss");
...
// exports
exports.locals = {
	"ListItem": "ListItem__ListItem___1SwCW",
	"CREATE": "ListItem__CREATE___3u4Ej",
	"remove-btn": "ListItem__remove-btn___3O110",
	"isDone": "ListItem__isDone___1UJBI"
};
...
// module
exports.push([module.i, ".ListItem__ListItems___2t9u6 {\n  display: block;\n  list-style: none;\n  overflow: auto;\n  max-height: 400px; }\n  .ListItem__ListItems___2t9u6 ul {\n    padding: 15px; }\n\n.ListItem__bareItem___vYB3j {\n  color: #b9b9b9;\n  list-style: none;\n  text-align: center;\n  font-size: 14px; }\n", ""]);

// exports
exports.locals = {
	"ListItems": "ListItem__ListItems___2t9u6",
	"bareItem": "ListItem__bareItem___vYB3j"
};
...
var _AddBar = __webpack_require__(32);
...
var AddBar = function (_React$Component) {
	...
	function AddBar(props) {
		_classCallCheck(this, AddBar);

		var _this = _possibleConstructorReturn(this, (AddBar.__proto__ || Object.getPrototypeOf(AddBar)).call(this, props));

		_this.addClickHandle = _this.addClickHandle.bind(_this);
		_this.addNewItem = _this.addNewItem.bind(_this);
	...
	_createClass(AddBar, [{
		...
		key: 'addClickHandle',
		value: function addClickHandle(props) {
		...
		value: function render() {
			var addBtn = "";
			if (this.state.value != '') {
				addBtn = _react2.default.createElement(
					'button',
					{ className: _AddBar2.default['add-btn'], onClick: this.addClickHandle },
					_react2.default.createElement(
						'span',
						null,
						'+'
			...
			return _react2.default.createElement(
				'div',
				{ className: _AddBar2.default[this.constructor.name] },
				_react2.default.createElement('textarea', { placeholder: 'Type something', onKeyUp: this.handleKeyUp, onChange: this.handleChange, value: this.state.value }),
				addBtn
			);
		}
	}]);
...
if(false) {
	module.hot.accept("!!../../../../node_modules/css-loader/index.js??ref--1-1!../../../../node_modules/sass-loader/lib/loader.js??postcss!./AddBar.scss", function() {
		var newContent = require("!!../../../../node_modules/css-loader/index.js??ref--1-1!../../../../node_modules/sass-loader/lib/loader.js??postcss!./AddBar.scss");
...
// exports
exports.locals = {
	"AddBar": "AddBar__AddBar___2y0aM",
	"add-btn": "AddBar__add-btn___F-eyd",
	"CREATE": "AddBar__CREATE___vMNsa"
};
...
if(false) {
	module.hot.accept("!!../../../../node_modules/css-loader/index.js??ref--1-1!../../../../node_modules/sass-loader/lib/loader.js??postcss!./ToDoList.scss", function() {
		var newContent = require("!!../../../../node_modules/css-loader/index.js??ref--1-1!../../../../node_modules/sass-loader/lib/loader.js??postcss!./ToDoList.scss");
...
// module
exports.push([module.i, ".ToDoList__ToDoList___2M57j {\n  max-width: 480px;\n  padding: 5px;\n  background: rgba(230, 232, 232, 0.21961);\n  margin: auto;\n  border-radius: 10px;\n  height: 100vh;\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between; }\n", ""]);

// exports
exports.locals = {
	"ToDoList": "ToDoList__ToDoList___2M57j"
};
